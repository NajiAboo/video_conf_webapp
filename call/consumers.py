...
class CallConsumer(WebsocketConsumer):
    ...
    def receive(self, text_data):
        ...
        if eventType == 'sendScreen':
            name = text_data_json['data']['name']
            print(self.my_name, "is sharing screen", name);
            # print(text_data_json)
    ...
    def screen_received(self, event):

        # print(event)
        print('Screend received by ', self.my_name )
        self.send(text_data=json.dumps({
            'type': 'screen_received',
            'data': event['data']
        }))
